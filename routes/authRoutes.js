...
const { registerUser, loginUser, verifyOTP, resendOTP, onboardEmployee, verifyTOTP, completeOnboarding } = require('../controllers/authController');
...
router.post('/onboard', protect, authorize('admin'), [
...
router.post('/complete-invite', [
    ...
    check('password', 'Password must be 8+ characters with special chars').isStrongPassword({ minLength: 8, minLowercase: 1, minUppercase: 1, minNumbers: 1, minSymbols: 1 }),
    validate
], completeOnboarding);
